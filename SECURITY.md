...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/wagasm-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/wagasm-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/wagasm-ssg/security/advisories)
...
When using wagasm-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/wagasm-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/wagasm-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/wagasm-ssg/discussions) |
...
*Thank you for helping keep wagasm-ssg and its users safe.* 🛡️
